...
6. [Uso por CLI](#-uso-por-cli)  
7. [Outputs Generados](#-outputs-generados)  
8. [Flujo Detallado por Variable](#-flujo-detallado-por-variable)  
9. [Estrategias de Referencia](#-estrategias-de-referencia)  
10. [Variables Especiales](#-variables-especiales)  
